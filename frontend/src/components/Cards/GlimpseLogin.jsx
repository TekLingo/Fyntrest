...
const GlimpseLogin = ({ moduleId, content, description, topics }) => {
	...
	const handleClick = () => {
		// Navigate to the module details page with the moduleId
		navigate(`/logged/module/${moduleId}`);
	};
