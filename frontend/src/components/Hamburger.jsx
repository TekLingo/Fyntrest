...
const Hamburger = () => {
  return (
    <div className="absolute -top-24 left-0 w-full h-96 bg-Menu bg-no-repeat bg-cover z-10 flex justify-center items-center transition-transform transform ease-in-out duration-500 select-none">
      {/* Menu Items */}
