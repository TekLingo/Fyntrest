...
//         <label className=" h-10 w-1/3 bg-purple-500 hover:bg-purple-600 p-2 text-center text-lg rounded-lg cursor-pointer">
//           Browse
//           <input
//             type="file"
//             multiple
...
//       </div>
//       <div
//         className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-purple-500 rounded-lg cursor-pointer hover:h-40"
//         onDrop={handleDrop}
