    ...
    <div className="flex flex-col gap-8 justify-center items-center bg-primary-b h-screen w-full text-text-g">
      ...
      <div className="flex flex-col items-center gap-6 p-4 w-96">
        ...
        <div className="w-full h-full mt-4">
          <button
            className="w-full h-12 rounded-md text-md bg-secondary-l hover:bg-secondary-d 
			transition-colors"
            onClick={handleLogin}
          >
            Login
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <p
            className="text-text-g cursor-pointer hover:underline select-none hover:text-secondary-lt"
