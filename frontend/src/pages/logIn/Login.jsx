...
//       </div>
//       <div className="flex flex-col items-center gap-8 p-4 w-96">
...
//           <input
//             type="password"
//             className="w-full rounded-md h-12 p-2 text-lg text-text-d bg-secondary-lt"
//           />
//         </div>
...
//           <p>
//             Dont have a account?
//             <a href="" className="text-secondary-lt hover:underline">
//               Register!
//             </a>
//           </p>
//         </div>
