...
const CoursePage = () => {
	...
	console.log(slug); // This will help you check the value of `slug`

	// Find the course based on the slug
	const course = courseData.find((course) => course.slug === slug);

	if (!course) {
		return <p className="text-white font-body text-xl">Course not found</p>; // Handle case where the course is not found
	}
