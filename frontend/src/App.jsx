			...
			<Router>
				<Routes>
					...
					<Route element={<ProtectedRoute allowedRoles={['student']} />}>
						...
						<Route path="/logged/course/:courseId" element={<LoginCoursePage />} />
						<Route path="/logged/module/:moduleId" element={<LoggedModulePage />} />
						<Route path="/logged/module/:moduleId/video/:videoId" element={<LoggedVideoPage />} />
						<Route path="/logged/quiz/:videoId" element={<Quiz />} />
						<Route path="/logged/profile" element={<LoggedProfilePage />} />
						<Route path="/logged/profile-detail" element={<LoggedProfileDetailPage />} />
					</Route>
